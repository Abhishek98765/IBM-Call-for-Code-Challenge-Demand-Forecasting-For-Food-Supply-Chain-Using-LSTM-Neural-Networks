...
def transform():
    ...
    finals=pd.DataFrame({'weeks':weeeks,'center_id':forecast_ids,'num_orders':forecastss})
    return finals
@app.route('/')
def form():
  return """
    <html>
        <body style="background-color:#FFFFFF;">
            <h1 style="text-align: center;"><strong>OPTIMIZED WAREHOUSE MANAGEMENT</strong></h1>
...
<hr style="border: 1.25px dashed black;margin-top:25px;" />
<br>


<p><span style="color: #ff0000;text-decoration: underline;margin-left:70px"><em>INSTRUCTIONS</em></span></p>
<ol>
<li><span style="color: #0000ff;"><em>Please Upload only the Historical Data file.</em></span></li><br>
<li><span style="color: #0000ff;"><em>Click on the Choose file button to upload the file.</em></span></li><br>
<li><span style="color: #0000ff;"><em>Click on the SUBMIT FILE button to submit the file.</em></span></li><br>
<li><span style="color: #0000ff;"><em>Please wait for some time while training takes place.</em></span></li><br>
<li><span style="color: #0000ff;"><em>The prediction file automatically gets downloaded.</em></span></li><br>
<li><span style="color: #0000ff;"><em>The predictions are in the result.csv file. </em></span></li>
</ol>
            </form>
        </body>
    </html>
